...
run-testnet-online:
	docker run --rm --ulimit "nofile=${NOFILE}:${NOFILE}" -v "${PWD}/qtum-data:/data" -e "MODE=ONLINE" -e "NETWORK=TESTNET" -e "PORT=8080" -p 8080:8080 -p 18333:18333 rosetta-qtum:latest

...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/coinbase/rosetta-bitcoin/qtumsuite/wire)
=======
...
```bash
$ go get -u github.com/coinbase/rosetta-bitcoin/qtumsuite/wire
```

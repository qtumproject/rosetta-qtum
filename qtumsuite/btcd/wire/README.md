...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/qtumproject/rosetta-qtum/qtumsuite/btcd/wire)
=======
...
```bash
$ go get -u github.com/qtumproject/rosetta-qtum/qtumsuite/btcd/wire
```
